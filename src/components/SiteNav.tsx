  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Logo */}
          <Link href="https://www.imagine.art/computer" className="inline-flex items-center shrink-0 no-underline">
            <img
          ...
          <div className="hidden lg:flex items-center gap-1 shrink-0">
            <a
              href="https://imagine.art/computer"
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[101] bg-white flex flex-col" style={{ animation: "mobileMenuIn 0.22s cubic-bezier(0.4,0,0.2,1) forwards" }}>
          <div className="flex items-center justify-between px-6 py-[18px] shrink-0">
            <Link href="https://www.imagine.art/computer" className="inline-flex items-center">
              <img
                src="/imagine-art-wordmark.svg"
                alt="ImagineArt"
                width={144}
